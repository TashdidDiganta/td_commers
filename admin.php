...
$get_id = $fetch_id['ID'];
 ...
 if(isset($_POST['update_product'])){
    if(!isset($_POST['product_title']) || !isset($_POST['product_description']) || !isset($_POST['product_price'])){
        ...
        $update_sql = "UPDATE `products` SET product_avatar = '$url', product_title = '$product_title', product_description = '$product_description', product_price = '$product_price', user_id = '$user_id' WHERE ID = '$product_id';";
                ...
                <div class="card-body">
                    ...
                    <table class="table table-borderless">
                        ...
                        <tbody>
                            ...
                            <div class="modal fade " id="editModal-<?php echo $fetch_product['ID']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text"  class="form-control" name="product_title" value="<?php echo $fetch_product['product_title']; ?>" id="recipient-name">
                                    </div>
                                    <div class="mb-3">
                                        <label for="message-text" class="col-form-label">Description:</label>
                                        <textarea class="form-control" name="product_description" id="message-text"><?php echo $fetch_product['product_description']; ?></textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="recipient-name" class="col-form-label">Price:</label>
                                        <input type="text" class="form-control" name="product_price" value="<?php echo $fetch_product['product_price']; ?>" id="recipient-name">
                                    </div>
                            ...
                            <?php
                              echo "<tr>";
                                  echo "<th>";
                                     echo !empty($fetch_product['product_avatar'])? "<img src='".$fetch_product['product_avatar']."' >" : '';
                                  echo "</th>";
                                  ...
                                  echo  "<td>";
                                       echo "<a href='edit_product.php?id={$fetch_product['ID']}' name='{$fetch_product['ID']}' class='btn btn-primary left' data-bs-toggle='modal' data-bs-target='#editModal-{$fetch_product['ID']}' data-bs-whatever='@mdo'>"."Edit". "</a>";
